...
This is still an early work-in-progress (i.e. "unusable").
...
- Decrypt `default.xex` with [xextool](https://digiex.net/threads/xextool-6-3-download.9523/): `xextool.exe -e u default.xex`. (optional for now)
